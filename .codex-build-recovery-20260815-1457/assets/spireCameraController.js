...
/**
 * Factory that manages Tower of Inspiration camera controls (zoom and pan).
 * Retired Spire camera hooks are intentionally excluded from the active runtime.
 *
 * @param {object} deps
 * @param {object} deps.powderState - Shared Tower of Inspiration state.
...
export function createSpireCameraController({
  ...
  /** Restore the Tower of Inspiration to its default framing. */
