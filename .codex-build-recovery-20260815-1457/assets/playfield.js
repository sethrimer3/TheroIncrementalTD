...
export class SimplePlayfield {
   ...
   * Delegates to WaveQueueSystem.
   */
  buildCurrentWaveQueue() {
    return WaveQueueSystem.buildCurrentWaveQueue.call(this);
  }
   ...
   */
  buildNextWaveQueue() {
    return WaveQueueSystem.buildNextWaveQueue.call(this);
  }
  ...
  buildActiveEnemyEntries() {
    return WaveQueueSystem.buildActiveEnemyEntries.call(this);
  }
  ...
  getEnemyVisualMetrics(enemy) {
    return EnemyFocusSystem.getEnemyVisualMetrics.call(this, enemy);
  }

  updateFocusIndicator(delta) {
    return EnemyFocusSystem.updateFocusIndicator.call(this, delta);
  }

  findEnemyAt(position) {
    return EnemyFocusSystem.findEnemyAt.call(this, position);
  }

  setEnemyHover(enemy) {
    return EnemyFocusSystem.setEnemyHover.call(this, enemy);
  }

  getFocusedEnemy() {
    return EnemyFocusSystem.getFocusedEnemy.call(this);
  }

  setFocusedEnemy(enemy, options = {}) {
    return EnemyFocusSystem.setFocusedEnemy.call(this, enemy, options);
  }

  clearFocusedEnemy(options = {}) {
    return EnemyFocusSystem.clearFocusedEnemy.call(this, options);
  }

  toggleEnemyFocus(enemy) {
    return EnemyFocusSystem.toggleEnemyFocus.call(this, enemy);
  }
  ...
  focusEnemyById(enemyId) {
    return EnemyFocusSystem.focusEnemyById.call(this, enemyId);
  }

  renderEnemyTooltip(enemy) {
    return EnemyFocusSystem.renderEnemyTooltip.call(this, enemy);
  }

  updateEnemyTooltipPosition() {
    return EnemyFocusSystem.updateEnemyTooltipPosition.call(this);
  }
  ...
  // Delegates to WaveQueueSystem for backward compatibility.
  createWaveState(config, options = {}) {
    return WaveQueueSystem.createWaveState.call(this, config, options);
  }
  ...
  getCycleMultiplierFor(cycle = this.endlessCycle) {
    return WaveQueueSystem.getCycleMultiplierFor.call(this, cycle);
  }
  ...
  getCycleSpeedScalarFor(cycle = this.endlessCycle) {
    return WaveQueueSystem.getCycleSpeedScalarFor.call(this, cycle);
  }
  ...
  scaleWaveConfigForCycle(waveConfig, cycle = this.endlessCycle) {
    return WaveQueueSystem.scaleWaveConfigForCycle.call(this, waveConfig, cycle);
  }
...
// Enemy update system methods
Object.assign(SimplePlayfield.prototype, {
  resolveEnemySlowMultiplier: EnemyUpdateSystem.resolveEnemySlowMultiplier,
  clearEnemySlowEffects: EnemyUpdateSystem.clearEnemySlowEffects,
  clearEnemyDamageAmplifiers: EnemyUpdateSystem.clearEnemyDamageAmplifiers,
  applyStunEffect: EnemyUpdateSystem.applyStunEffect,
  isEnemyStunned: EnemyUpdateSystem.isEnemyStunned,
...
// Tower dispatch system methods
Object.assign(SimplePlayfield.prototype, {
  updateTowers: TowerDispatchSystem.updateTowers,
  findTarget: TowerDispatchSystem.findTarget,
