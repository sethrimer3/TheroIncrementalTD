...
export const psi = {
  ...
  baseEquation: String.raw`\( \psi = \text{CD} \times \text{count}_{\text{max}} \)`,
  variables: [
    {
      key: 'mergeCooldown',
      symbol: String.raw`\text{CD}`,
      equationSymbol: String.raw`\text{CD}`,
    ...
    },
    {
      ...
      masterEquationSymbol: 'count_max',
      glyphLabel: 'ℵ₂',
