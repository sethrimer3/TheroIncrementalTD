...
export const rho = {
    ...
    computeResult(values) {
        const enemyThero = Math.max(0, isFiniteNumber(values.enemyThero) ? values.enemyThero : 0);
        const range = Math.max(0, isFiniteNumber(values.rangeMeters) ? values.rangeMeters : 0);
